...
const PurchaseButton: FC<PurchaseButtonProps> = ({ slice }) => {
  ...
  return (
    ...
    >
      <FadeIn className="relative mx-auto max-w-7xl text-center" targetChildren>
        <p className="mb-6 text-xl font-medium text-gray-700 md:text-2xl">
          {slice.primary.eyebrow}
        </p>
        <h2 className="mb-8 scroll-pt-6 font-bold-slanted text-5xl text-gray-900 uppercase md:text-7xl lg:text-8xl">
        ...
        <button
          ...
          disabled={isPressed}
          className={clsx(
            "group relative w-full overflow-hidden rounded-full border-8 border-gray-900 bg-linear-to-r/oklch from-sky-300 to-sky-600 px-6 py-6 ease-out focus:ring-[24px] focus:ring-sky-50 focus:outline-none motion-safe:transition-all motion-safe:duration-300 md:border-[12px] md:px-20 md:py-16",
        ...
        >
          ...
          <div className="relative z-10 flex items-center justify-center gap-6 md:gap-8">
            <span
              ...
              className="font-black-slanted text-4xl tracking-wide text-gray-900 uppercase group-hover:-translate-y-1 motion-safe:transition-transform motion-safe:duration-300 md:text-7xl lg:text-8xl"
            >
              {isPressed ? (
